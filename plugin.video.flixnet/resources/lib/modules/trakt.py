...
def getTrakt(url, post=None):
    try:
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '1fc908710290411aa48d6cb599ef13f72c25c8c4c86c99d8d2cc3d8983fc4235', 'trakt-api-version': 2}
        ...
        opost = {'client_id': '1fc908710290411aa48d6cb599ef13f72c25c8c4c86c99d8d2cc3d8983fc4235', 'client_secret': '0a361de39a8e9038da91971c23b69fa2860d6f14d8a2f4d57522889c05a1e5f1', 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob', 'grant_type': 'refresh_token', 'refresh_token': control.setting('trakt.refresh')}
...
def authTrakt():
    try:
        ...
        result = getTrakt('/oauth/device/code', {'client_id': '1fc908710290411aa48d6cb599ef13f72c25c8c4c86c99d8d2cc3d8983fc4235'})
        result = json.loads(result)
        ...
        for i in range(0, expires_in):
            try:
                ...
                r = getTrakt('/oauth/device/token', {'client_id': '1fc908710290411aa48d6cb599ef13f72c25c8c4c86c99d8d2cc3d8983fc4235', 'client_secret': '0a361de39a8e9038da91971c23b69fa2860d6f14d8a2f4d57522889c05a1e5f1', 'code': device_code})
                r = json.loads(r)
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': '1fc908710290411aa48d6cb599ef13f72c25c8c4c86c99d8d2cc3d8983fc4235', 'trakt-api-version': '2', 'Authorization': 'Bearer %s' % token}
